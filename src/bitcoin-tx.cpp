...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cooktipcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cooktipcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cooktipcoin transaction") + "\n" +
              "  cooktipcoin-tx [options] -create [commands]   " + _("Create hex-encoded cooktipcoin transaction") + "\n" +
              "\n";
