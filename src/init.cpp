...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cooktipcoin-project/cooktipcoin>";
    const std::string URL_WEBSITE = "<https://cooktipcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Cooktipcoin version %s\n", FormatFullVersion());
}
