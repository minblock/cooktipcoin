...
{
    const char* pszTimestamp = "4/2/2020 Provigen Networks: now accepting spacetriposhis";
...
public:
    CMainParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.cooktipcoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("cooktipcointools.com", "dnsseed.cooktipcointools.com"));
        //vSeeds.push_back(CDNSSeedData("cooktipcoinpool.org", "dnsseed.cooktipcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, , 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x"));
        assert(genesis.hashMerkleRoot == uint256S("0x"));
        ...
        //vSeeds.push_back(CDNSSeedData("cooktipcointools.com", "testnet-seed.cooktipcointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.cooktipcoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, , 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x"));
        assert(genesis.hashMerkleRoot == uint256S("0x"));
